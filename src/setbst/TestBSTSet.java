...
//		a5.printBSTSet();
		...
		try {
			...
			if (a1.height() >= 0) {
				System.out.println("The height d1 is " + a1.height() + " --> Pass (+0.5)"); // height should be minimum
																							// for bonus
				FinalMarks = FinalMarks + half_mark;
			} else
...
//		System.out.println("The height d1 is " + a1.height()); //height should be minimum for bonus
		...
		// System.out.println("The size of the empty set is " + a0.size()); // should be
		// 0
		// System.out.println("The height of the empty set is " + a0.height());//should
		// be -1
		System.out.println("\n");
...
//		System.out.println("\n");
	...
	static int CompareBST(TNode root1, TNode root2) {
		...
		// Condition to check if one of the trees is empty
			...
			if (root1.element == root2.element && CompareBST(root1.left, root2.left) == 1
	...
	static boolean Compistree(int v, TNode root2) {
		/*
		 * Time Complexity: n, log n for full tree Space Complexity: n, log n for full
		 * tree
		 */
